...
/**
 * PlanImpl is responsible for how to implement a service.
 * It knows
 * - the @Behavior it is responsible for implementing.
 * - the @Description of a builder to to the work.
 *
 * behavior (description of ideal externally visibile behavior)
 * quality (description of how close actual behaviour comes to the ideal)
 * construction (description of how service is implemented)
 * interfaces (description of service references used by clients)
 *
 ...
 */
public class PlanImpl implements Plan, Access {

    private static final Logger logger = Logger.getLogger(PlanImpl.class);
    ...
    public PlanImpl(Map<String, Object> jsonObject) {
    ...
    public PlanImpl computeStatus() {
        ...
        if (builderDescription != null && dependencies != null) {
            ...
            for (Object o: dependencies.values()) {
                if (o instanceof PlanImpl) {
                    leastDependencyStatus = Integer.min(((PlanImpl) o).status, leastDependencyStatus);
                }
            }
        ...
        if (jsonObject.containsKey(fieldName)) {
            ...
            if (value instanceof Map) {
                if (fieldName.equals("properties") || fieldName.equals("dependencies")) {
                    ...
                    value = new PlanImpl((Map<String, Object>)value);
                }
            }
            return (T)value;
        } else {
    ...
    private Map<String, Object> mapSupportingNestedDescriptions(Map<String, Object> map) {
        for (String key: map.keySet()) {
            ...
            if (value instanceof Map) {  // restriction: all map values in properties or dependencies are Descriptions
                PlanImpl desc = new PlanImpl((Map<String,Object>)value);
                map.put(key, desc);
            } else if (value instanceof List) {
                List<Object> newList = new ArrayList();
                for (Object o: (List)value) {
                    if (o instanceof Map) {
                        newList.add( new PlanImpl((Map<String, Object>)o));
                    } else {
                        newList.add(o);
                    }
                }
    ...
    public PlanImpl setName(String n) {
        this.behavior.setProperty("name",n);
        return this;
    }

    public PlanImpl setType(String t) {
    ...
    public PlanImpl setProperties(Map<String, Object> p) {
        this.behavior.setProperties(p);
        return this;
    }

    @Override
    public PlanImpl setBuilderDescriptions(PlanImpl d) {
        builderDescription = d;
        return this;
    }

    @Override
    public PlanImpl setDependencies(Map<String, Object> d) {
        dependencies = d;
        return this;
    }

    public PlanImpl setProperty(String key, Object value) {
        this.behavior.setProperty(key, value);
        return this;
    }

    public PlanImpl setServiceObject(Object o) {
        serviceObject = o;
        return this;
    }

    public PlanImpl setInterfaces(Map<String, String> i) {
        interfaces = i;
        return this;
    }

    public PlanImpl setStatus(int s) {
        status = s;
        return this;
    }
    ...
    public List<PlanImpl> listDescriptionProperty(String key) {
        return (List<PlanImpl>)properties().get(key);
    }
    ...
    public PlanImpl plan() throws NoImplementationFound {
        return plan(null);
    }
     ...
     */
    public PlanImpl plan(Repository repo) throws NoImplementationFound {
        if (isPlanned()) {
            return this;
        }
        PlanImpl impl = repo.bestMatch(this);
        if (impl == null) {
    ...
    public PlanImpl copy(PlanImpl goal) {
    ...
    public PlanImpl provision() throws NoImplementationFound {
     ...
     */
    @Override
    public PlanImpl provision(Repository repo) throws NoImplementationFound {
        if (isProvisioned()) {
            return this;
        }
        if (!isPlanned()) {
    ...
    @Override
    public PlanImpl assemble() throws NoImplementationFound {
        return assemble(null);
    }

    @Override
    public PlanImpl assemble(Repository repo) throws NoImplementationFound {
        if (isAssembled()) {
            return this;
        }
        if (!isProvisioned()) {
    ...
    @Override
    public PlanImpl activate() throws NoImplementationFound {
        return activate(null);
    }

    @Override
    public PlanImpl activate(Repository repo) throws NoImplementationFound {
        if (isActive()) {
