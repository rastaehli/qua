...
//        repo.advertise(JvmObjectBuilder(Class cls, List<Class> constructorArgTypes, List<Object> ));
        ...
        describe = new Describer(new HashMap<>());
    }
    ...
    public void test_matchFor_success() {
        ...
        Description goal = describe.typeAndProperties("goaltype", goalProperties);
        ...
        Description conformingDesc = describe.typeAndProperties("goaltype", conformingProperties);
