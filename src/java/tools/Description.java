...
public class Description {
    ...
    public static String getType(Map<String,Object> o) {
        if (o.containsKey("type")) {
            ...
            throw new IllegalStateException("Json description object has no type.");
        }
    }
    ...
    public static Description fromJsonFile(String path) {
        try {
            return new Description(new Gson().fromJson(new FileReader(Paths.get(path).toFile()), Map.class));
        } catch (IOException e) {
            e.printStackTrace();
        }
